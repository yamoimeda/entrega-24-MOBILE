...
export default class Companias extends React.Component {
  ...
  ir = it => {
    this.setState({cliente: it.cliente_nombre, clienteuid: it.uid,modalproductos: true});
  };
    ...
    return (
      <View style={styles.container}>
        ...
        <Modal
          ...
          <Productos cliente={this.state.cliente} clienteuid={this.state.clienteuid} cerrar ={()=>this.setState({modalproductos: false,clienteuid:'',cliente:''})}/>
        </Modal>
      </View>
    );
  }
